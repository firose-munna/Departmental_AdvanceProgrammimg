...
public class deleteQuestion extends javax.swing.JFrame {
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try{
            ...
            if(rs.first()){
                ...
                JOptionPane.showMessageDialog(jf, "Question No does not Exist.");
            }
        }
        catch(Exception e){
            JFrame jf = new JFrame();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            Connection con = ConnectionProvider.getCon();
            PreparedStatement ps = con.prepareStatement("delete from questionset where question_no=?");
            ...
            JFrame jf = new JFrame();
            jf.setAlwaysOnTop(true);
            JOptionPane.showMessageDialog(jf, "Succesfuly Deleted"); 
            setVisible(false);
